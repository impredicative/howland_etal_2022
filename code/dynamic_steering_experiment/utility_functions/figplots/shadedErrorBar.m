...
params.addParameter('lineProps', '-k', @(x) iscell(x));
...
params.addParameter('vertical', 1, @(x) isnumeric(x));
...
vertical = params.Results.vertical;
...
if vertical==1;
    ...
    H = makePlot_xaxis(x,y,errBar,lineProps,transparent,patchSaturation);
end
...
function H = makePlot_xaxis(x,y,errBar,lineProps,transparent,patchSaturation)
